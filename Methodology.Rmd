...
where $\lambda_t$ is the speciation rate, $\mu_t$ is the extinction rate and $T$ is the time to present. To simulate random numbers from that distribution we can use two ways. The first assumes that both $lambda_t$ and $\mu_t$ are constant in a interval $(0,T)$, and the follows the steps 
