...
\begin{equation}h_2(y=CT,\theta) = \displaystyle\int_0^{T}\displaystyle\int_0^{T-t_1} \displaystyle\int_0^{T-t_1-t_2}\displaystyle\int_0^{T-t_1-t_2-t_3} (\mu \lambda)^2 e^{-s_1t_1-s_2t_2-s_3t_3-s_4t_4} dt_4dt_3dt_2 dt_1 \end{equation}
...
mu[14]
f.true[14]
s1 = c(2,3,4,3)*c(lambda,lambda+mu[14],mu[14],mu[14])
s2 = c(2,3,2,3)*c(lambda,lambda+mu[14],lambda,mu[14])
s3 = c(2,3,2)*c(lambda,lambda+mu[14],lambda)
s1
s2
s3
h2(s1,CT)
